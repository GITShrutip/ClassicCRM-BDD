...
public class LoginTest {
	...
	public void i_enter_valid_email_id_and_password() {
	    ...
	    contextClass.pageObjectManager.getLoginPage().enterLoginDetails(prop.getProperty("uname"), prop.getProperty("password"));
	    //contextClass.loginPage.enterLoginDetails(prop.getProperty("uname"), prop.getProperty("password"));
	}
